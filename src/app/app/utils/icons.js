...
import DispatchFulfilled from "@/app/utils/svg/DispatchFulfilled.svg";
import EngravingRequest from "@/app/utils/svg/EngravingRequest.svg";
import InventoryLevelEngraving from "@/app/utils/svg/InventoryLevelEngraving.svg";
...
export const ICONS = {
  ...
  dispatchFulfilled : <DispatchFulfilled className="h-6 w-6 text-dark-4" />,
  engravingRequest : <EngravingRequest className="h-6 w-6 text-dark-4" />,
  inventoryLevelEngraving : <InventoryLevelEngraving className="h-6 w-4 text-dark-4" />,
}
